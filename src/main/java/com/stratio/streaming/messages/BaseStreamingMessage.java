...
public class BaseStreamingMessage implements Serializable {
	 ...
	 * @param columns
	 */
	public BaseStreamingMessage(String streamName, List<ColumnNameTypeValue> columns) {
		super();
	 ...
	 * @param columns
	 */
	public BaseStreamingMessage(String streamName, Long timestamp, List<ColumnNameTypeValue> columns) {
		super();
		this.streamName = streamName;
