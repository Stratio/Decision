package com.stratio.streaming.unit.messanging.api

import com.stratio.streaming.api.messaging.{MessageBuilderWithColumns, MessageBuilder, ColumnNameValue, ColumnNameType}
